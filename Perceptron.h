ㅇㅇ
먼저, 이 헤더파일은 퍼셉트론 클래스를 정의한 헤더파일이야.
클래스는 객체지향프로그래밍및실습 과목에서 JAVA 배우면서 배운게 있다면 그거랑 같은 말이야
기억이 안 나거나 안 배웠다면, 클래스는 C언어 구조체같은거라고 보면 돼
C언어 구조체를 잘 모르겠다면 음 하나의 객체라고 일단 생각하면 돼
사람들이 흔히 클래스는 붕어빵 찍어내는 틀이라고 비유를 하는데, 맞는 표현은 아니라서 갑론을박이 있긴 하지만 일단 뭐 입문자 입장에선
비슷비슷 할거야
암튼
